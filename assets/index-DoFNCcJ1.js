...
let id = 0;
function KC_worker_helper(worker) {
  const jobs = /* @__PURE__ */ new Map();
  const post = (req) => {
    worker.postMessage(req);
    return new Promise(
      (res) => jobs.set(req.id, res)
    );
  };
  ...
  return (all_colors, k, range) => post({
    id: ++id,
    message: { all_colors, k, range }
  });
}
function img_2_img_data(img) {
  const canvas = new OffscreenCanvas(img.width, img.height);
  const ctx = canvas.getContext("2d");
  ctx.drawImage(img, 0, 0);
  return ctx.getImageData(0, 0, img.width, img.height);
}
function img_data_2_colors(img_data) {
...
function clusters_2_img_data(clusters, width, height) {
...
async function img_data_2_img_blob(img_data, opts) {
...
function WorkerWrapper(options) {
  return new Worker(
    "/k-colors.js/assets/index-tWx66Szz.js",
    {
...
function App() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("hgroup", { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { children: "k-colors.js" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "Extract dominant colors from images using the k-means/k-means++ algorithm." }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { children: [
        "links: ",
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "a",
          {
            href: "https://github.com/ppzreboot/k-colors.js",
            children: "k-colors.js"
          }
        ),
        " | ",
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "a",
          {
            href: "https://github.com/ppzreboot/k-means-pp.js",
            children: "k-means-pp.js"
          }
        )
      ] })
    ] }),
...
function useInput_img() {
  const [src, set_src] = reactExports.useState(null);
  const [img, set_img] = reactExports.useState(null);
  return {
    img,
    el: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "block", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "input",
        {
          type: "file",
      ...
      src && /* @__PURE__ */ jsxRuntimeExports.jsx("img", { className: "block", src, style: img_style })
    ] })
  };
}
function useInput_k() {
  const [k, set_k] = reactExports.useState("6");
  const [valid, set_valid] = reactExports.useState(true);
  return {
    k: valid ? Number(k) : null,
    el: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "block", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("label", { children: "k: " }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "input",
        {
          type: "number",
          ...
          onChange: (e) => {
            ...
            set_k(k_str);
            const k2 = Number(k_str);
            set_valid(Number.isInteger(k2) && k2 > 0);
          }
        }
      ),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { color: "red" } })
    ] })
  };
}
function usePallet(img, k) {
  ...
  const [colors, set_colors] = reactExports.useState(null);
  const [clustered_img, set_clustered_img] = reactExports.useState(null);
  reactExports.useEffect(() => {
    ...
    async function work(img2, k2) {
      ...
      const clusters = await kc(all_colors, k2, range);
  ...
  const [focused_color, set_focused_color] = reactExports.useState(null);
  reactExports.useEffect(() => {
    if (colors) {
  ...
  return {
    colors,
    el: working ? "working..." : /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
      colors && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "block", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { children: "Pallet" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("ul", { className: "pallet", children: colors.map(
          (color, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(
            "li",
            {
      ...
      clustered_img && /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: clustered_img, className: "block", style: img_style }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("a", { href: clustered_img, download: "clustered.png", children: "download" })
      ] })
    ] })
  };
}
